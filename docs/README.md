...
This directory contains Conductor's reviewed product and engineering decisions. Design documents describe intent and trade-offs before implementation details.
...
- [`state-machines.md`](state-machines.md) defines legal lifecycle transitions and race-handling rules.
- [`roadmap.md`](roadmap.md) splits V1 into independently demonstrable milestones.
